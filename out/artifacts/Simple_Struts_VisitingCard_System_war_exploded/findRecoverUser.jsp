...
<html>
  ...
  <body>
    	 ...
    	 <center>
	 <table class="am-table am-table-bordered am-table-radius am-table-striped" cellspacing="2" cellpadding="2" border="2" bordercolor="#c0c0c0">
	 <tr>
		...
		<tr>
	 		...
	 		<s:form cssClass="am-form" action="selectRecoverMuddy" method="post">
