...
<html>
	...
	<body>
		...
		<center>
			...
			<br>
			<table cellspacing="2" cellpadding="2" border="2" class="am-table am-table-bordered am-table-radius am-table-striped"bordercolor="#c0c0c0">
				<tr>
					<td align="center">
						编号
					</td>
		...
		<s:form cssClass="am-form" action="selectMuddy" method="post">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="condition"
				label="查询条件" />
				<s:submit cssClass="am-btn-warning" class="am-btn-warning" name="select" value="查询"></s:submit>
		</s:form>
		</center>
